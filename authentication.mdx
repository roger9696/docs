...
PayX uses API Keys to authenticate requests. You can view and manage your API keys in the [PayX Dashboard](https://payx.app/dashboard).
...
```bash
curl -X POST https://api.payx.app/v1/charge \
